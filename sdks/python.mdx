---
title: "Python SDK"
description: "The official `dragdropdo-sdk` package provides a high‑level, type‑safe interface to the D3 Business API.
"
---
...
```python
from dragdropdo_sdk import Dragdropdo, D3APIError, D3ValidationError
import os
