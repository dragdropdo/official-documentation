...
1. **New to D3?** Start with the [Quickstart](/docs/quickstart) guide
2. **Ready to integrate?** Check out the [Business API Overview](/docs/business-api/overview)
3. **Prefer SDKs?** Explore the [Node.js SDK](/docs/sdks/node) documentation
